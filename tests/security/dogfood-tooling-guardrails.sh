...
# --- Dogfood report: credentials stay off every host-process boundary -------
# No line may echo an API key or mobile/database secret. PostgreSQL passwords
# enter the container over stdin; Docker argv and inherited host environments
# are covered functionally by db-secret-transport-guardrails.sh.
